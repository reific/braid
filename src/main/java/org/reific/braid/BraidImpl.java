 ...
 *   in a reported size of 24 bytes. This means that there should be 4 free bytes available for future changes. This also means that if there
 ...
 * 
 */
class BraidImpl implements Braid {
